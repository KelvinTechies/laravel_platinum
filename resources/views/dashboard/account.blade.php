                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body pt-0 p-3 text-center">
                                <span class="text-xs">{{ Auth::user()->acct_num }}</span>
                                <hr class="horizontal dark my-3">
                                <h2 class="mb-0">$941,220,010.00</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 mb-xl-0 mb-4">
                        <div class="card bg-transparent shadow-xl">
                            ...
                            <div class="overflow-hidden position-relative border-radius-xl">
                                <img src="assets/img/pattern-tree.svg"
                                ...
                                <div class="d-flex align-items-center">
                                    <button
                                        class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i
                                            class="material-icons text-lg">expand_less</i></button>
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Bank Interest</h6>
                                ...
                                <div class="d-flex align-items-center">
                                    <button
                                        class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i
                                            class="material-icons text-lg">expand_less</i></button>
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">TV Subscription</h6>
                                ...
                                <div class="d-flex align-items-center">
                                    <button
                                        class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i
                                            class="material-icons text-lg">expand_less</i></button>
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Royalty</h6>
